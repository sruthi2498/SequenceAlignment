...
mat = []
def forwards1(x, y, simMatrix, gapPenalty):
    n, m = len(x), len(y)
    # mat = []
    global mat
...
def backwards1(x, y, simMatrix, gapPenalty):
...
def hirschberg(x, y, simMatrix, gapPenalty):
    ...
    if n<2 or m<2:
        ...
        F, B = forwards1(x[:n//2], y, simMatrix, gapPenalty), backwards1(x[n//2:], y, simMatrix, gapPenalty)
